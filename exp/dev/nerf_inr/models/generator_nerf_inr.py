...
from exp.pigan.models.siren import (CustomMappingNetwork, UniformBoxWarp,
                                    first_layer_film_sine_init, frequency_init)
...
class NeRFNetwork(nn.Module):
    ...
    def __init__(self,
        ...
        self.style_dim_dict[f'{name_prefix}_network'] = len(
            self.network) * hidden_dim * 2
