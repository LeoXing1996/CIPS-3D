...
class ResBlock(nn.Module):
    def __init__(self,
        ...
        if first_downsample:
            self.conv1 = ConvLayer(in_channel,
                                   in_channel,
                                   kernel_size,
...
class Discriminator_MultiScale(nn.Module):
    ...
    def __init__(self,
        ...
        self.space_linear = EqualLinear(channels[4] * 4 * 4,
                                        channels[4],
                                        activation='fused_lrelu')
...
class Discriminator_MultiScale_Aux(nn.Module):
    ...
    def __init__(self,
        ...
        self.main_disc = Discriminator_MultiScale(
            diffaug=diffaug,
            max_size=max_size,
            channel_multiplier=channel_multiplier,
            first_downsample=first_downsample,
        ...
        self.aux_disc = Discriminator_MultiScale(
            diffaug=diffaug,
            max_size=max_size,
            channel_multiplier=channel_multiplier,
    ...
    def forward(self,
        ...
        if use_aux_disc:
            ...
            out, latent, position = self.main_disc(input,
                                                   alpha,
